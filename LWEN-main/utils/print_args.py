def print_args(args):
    ...
    print("\033[1m" + "Frequency Split Ratio" + "\033[0m")
    low_ratio, mid_ratio, high_ratio = args.split_ratio
    hid_ratio = args.hid_ratio
    window_size = args.window_size
    window = args.window_type
    print(f'  {"Low Freq Ratio:":<20}{low_ratio:<20}{"Mid Freq Ratio:":<20}{mid_ratio:<20}')
    print(f'  {"High Freq Ratio:":<20}{high_ratio:<20}{"Hid Ratio:":<20}{hid_ratio:<20}')
    print(f'  {"Window Size:":<20}{window_size:<20}{"Window:":<20}{window:<20}')
    print()
