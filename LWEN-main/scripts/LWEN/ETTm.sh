...
python -u ../../run.py \
  ...
  --learning_rate 0.005 \
  --des 'Exp' \
  --itr 1 >logs/LongForecasting/"ETTm2_${win}_size${win_size}_hidd${hid}_$(echo ${ratio} | tr ' ' '_')_96_96.log"
...
python -u ../../run.py \
  ...
  --learning_rate 0.005 \
  --des 'Exp' \
  --itr 1 >logs/LongForecasting/"ETTm2_${win}_size${win_size}_hidd${hid}_$(echo ${ratio} | tr ' ' '_')_96_192.log"
...
python -u ../../run.py \
  ...
  --learning_rate 0.005 \
  --des 'Exp' \
  --itr 1 >logs/LongForecasting/"ETTm2_${win}_size${win_size}_hidd${hid}_$(echo ${ratio} | tr ' ' '_')_96_336.log"
...
python -u ../../run.py \
  ...
  --learning_rate 0.005 \
  --des 'Exp' \
  --itr 1 >logs/LongForecasting/"ETTm2_${win}_size${win_size}_hidd${hid}_$(echo ${ratio} | tr ' ' '_')_96_720.log"
